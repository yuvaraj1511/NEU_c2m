      ...
      <div className="max-w-md mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="relative group cursor-pointer">
            ...
            {/* Dropdown Menu (Hover) */}
            <div className="absolute top-full right-0 mt-2 w-64 bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 p-4">
              {!user ? (
                <>
